    ...
    <div class="row">
        ...
        <div class="col-md-9 mt-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <a href="{{url('/examiner/exam/edit')}}/{{$item->id}}">
                    <div class="card bg-default mb-4" style="max-width: 20rem;">
                        ...
                        <div class="card-body">
                            ...
                            <center>
                                ...
                                height: 60px; border-radius:50px;">
                                    <i style="font-size: 20px; margin-top:1.2rem; color:#fff" class="fas fa-drafting-compass "></i>
